...
// Source: "World Model Competitive Landscape" sheet — companies with a
// publicly released world model. Axes: training data (2D ↔ 3D, vertical) ×
// application (Entertainment ↔ Robotics/AV, horizontal).
const competitiveEntries: CompetitiveLandscapeEntry[] = [
  {
    name: "Odyssey",
    logo: "/landscape-logos/odyssey.png",
    model: "Odyssey-2",
    application: "Entertainment",
    trainingData: "2D",
    inputs: ["Camera", "Action"],
    outputs: ["Video"],
    interaction: "Prompt, choice of two actions at a time; look around with your mouse",
    horizon: "Multiple minutes",
    pricing: "Beta offered for free",
    mapX: 16, mapY: 26,
  },
  {
    name: "Decart",
    logo: "/landscape-logos/decart.png",
    model: "Oasis",
    application: "Entertainment",
    trainingData: "2D",
    inputs: ["Camera", "Action"],
    outputs: ["Video"],
    interaction: "Move with WASD, look with your mouse, jump with Space, run with Ctrl, inventory with E, sneak with Shift.",
    horizon: "Up to 5 seconds",
    pricing: "Beta offered for free / open weight",
    mapX: 28, mapY: 12,
  },
  {
    name: "Overworld",
    logo: "/landscape-logos/overworld.png",
    model: "Waypoint 1.5",
    application: "Entertainment",
    trainingData: "2D",
    inputs: ["Camera", "Action"],
    outputs: ["Video"],
    interaction: "Move with WASD, look with your mouse",
    horizon: "30 seconds",
  ...
  {
    name: "Moonlake",
    logo: "/landscape-logos/moonlake.png",
    model: "Reverie",
    application: "Entertainment, Robotics",
    trainingData: "2D / 3D Semantics",
    inputs: ["Camera", "Action"],
    outputs: ["Video"],
    interaction: "Move with WASD, look with your mouse, jump with Space, sprint with Shift, free the mouse with ESC.",
    horizon: "Very long (worlds are persistent)",
    pricing: "$15 / month per 1,000 credits",
    mapX: 47, mapY: 58,
  },
  {
    name: "Google",
    logo: "/landscape-logos/deepmind.png",
    model: "Genie",
    application: "Entertainment, AV",
    trainingData: "2D",
    inputs: ["Camera", "Language", "Action"],
    outputs: ["Video", "Action"],
    interaction: "Move with WASD, jump with space, look with the arrow keys",
    horizon: "60 seconds",
    pricing: "Google AI Ultra ($99.99 / month)",
    mapX: 55, mapY: 16,
  },
  {
    name: "Runway AI",
    logo: "/landscape-logos/runway.png",
    model: "GWM-1",
    application: "Entertainment, Robotics",
    trainingData: "2D",
    inputs: ["Camera", "Proprioception", "Language", "Action"],
    outputs: ["Video", "Action"],
    interaction: "Prompt, move with WASD",
    horizon: "Not disclosed",
    pricing: "Not disclosed",
    mapX: 44, mapY: 26,
  },
  {
    name: "World Labs",
    logo: "/landscape-logos/world-labs.png",
    model: "Marble",
    application: "Entertainment, Robotics",
    trainingData: "3D",
    inputs: ["Camera", "Language", "Goal Image"],
    outputs: ["Video", "State", "Image"],
    interaction: "Move with WASD, up/down with E/Q, faster with Shift, adjust FOV, toggle Natural Mouse.",
    horizon: "Very long (worlds are persistent)",
    pricing: "$0.80 / 1,000 credits (min. $5 for 6,250)",
    mapX: 34, mapY: 86,
  },
  {
    name: "Rhoda AI",
    logo: "/landscape-logos/rhoda.png",
    model: "Direct Video-Action",
    application: "Robotics",
    trainingData: "2D",
    inputs: ["Camera", "Proprioception", "Language", "Action"],
    outputs: ["Video", "Action"],
    interaction: "Not applicable",
    horizon: "Robotics task: ~5 minutes",
    pricing: "RaaS model",
    mapX: 83, mapY: 18,
  },
  {
    name: "Genesis AI",
    logo: "/landscape-logos/genesis-ai.png",
    model: "Genesis-26.5",
    application: "Robotics",
    trainingData: "2D",
    inputs: ["Proprioception", "Language", "Goal Image"],
    outputs: ["Video", "Action", "State", "Image", "Trajectories"],
    interaction: "Not applicable",
    horizon: "Robotics task: 4 minutes (from demo)",
    pricing: "Not commercialized",
    mapX: 93, mapY: 32,
  },
  {
    name: "NVIDIA · Dream Zero",
    logo: "/landscape-logos/nvidia.png",
    model: "Dream Zero",
    application: "Robotics",
    trainingData: "2D",
    inputs: ["Camera", "Proprioception", "Language", "Action"],
    outputs: ["Video", "Action", "Trajectories"],
    interaction: "Not applicable",
    horizon: "Tasks up to 10 minutes",
    pricing: "Open sourced",
    mapX: 74, mapY: 40,
  },
  {
    ...
    logo: "/landscape-logos/nvidia.png",
    model: "Cosmos",
    application: "AV, Robotics",
    trainingData: "2D",
    inputs: ["Camera", "Proprioception", "Language", "Goal Image"],
    outputs: ["Video"],
    interaction: "Not applicable",
    horizon: "Video: 30s · Robot actions: 44s",
    pricing: "Open sourced",
    mapX: 60, mapY: 8,
  },
];
