import type { Article, CompetitiveLandscapeEntry, TocItem } from "./types";

const competitiveEntries: CompetitiveLandscapeEntry[] = [
  {
    name: "Embo",
    category: "Generative Latent Simulation",
    hq: "San Francisco, CA",
    founded: "2026",
    valuation: "Raising $120M seed",
    funding: "N/A",
    gtm: "Robotics",
    teamResearch: "Danijar Hafner (Dreamer 1–4), Wilson Yan (co-author Dreamer 4)",
    teamCommercial: "N/A",
    stateSpace: "Latent State",
    mapX: 74, mapY: 52,
  },
  {
    name: "World Labs",
    category: "Generative 3D Models",
    hq: "San Francisco, CA",
    founded: "2023",
    valuation: "$6.6B",
    funding: "$817M from a16z, Samsung Ventures, NVentures, AMD Ventures, Adobe Ventures",
    gtm: "Creative / media, gaming, simulation & architecture workflows",
    teamResearch: "Feifei Li (ImageNet), Justin Johnson, Christoph Lassner, Ben Mildenhall (NeRF co-inventor)",
    teamCommercial: "1 Biz & Ops hire; Feifei and Justin driving commercial",
    stateSpace: "3D",
    horizon: "Very long (persistent, reloadable worlds)",
    resolution: "High-quality 3D scenes, exportable",
    pricing: "Free (4 gen) / $20 / $35 / $95 per month",
    mapX: 20, mapY: 82,
  },
  {
    ...
    hq: "San Francisco, CA",
    founded: "2024",
    valuation: "Raising $60M Series A",
    funding: "$7M seed — Felicis Ventures, Abstract Ventures, MVP",
    gtm: "Robotics, drones, AVs; spatial content creation",
    teamResearch: "Tolga Kart (CEO, ex-Tesla Autopilot TPM), Piotr Sokolski (CTO, ex-Wayve neural sim), Christian Rupprecht (Oxford)",
    teamCommercial: "Founder-led sales",
    stateSpace: "3D",
    mapX: 65, mapY: 78,
  },
  {
    ...
    valuation: "—",
    funding: "—",
    gtm: "Gaming (indie devs & solos); Robotics — $40/mo subscription",
    teamResearch: "3D generative model PhDs; ~15 people, software background",
    teamCommercial: "Sign-up platform; Raymond Wang + 1 FTE",
    stateSpace: "3D",
    horizon: "Long horizon; some temporal artifacts; real-time capable",
    latency: "Real-time with accurate collision response",
    pricing: "Free / $40 per month",
    mapX: 42, mapY: 72,
  },
  {
    name: "Odyssey",
    category: "Generative 2D Models",
    hq: "Santa Clara, CA / London",
    founded: "2023",
    valuation: "~$500M cap (Dec 2025)",
    funding: "—",
    gtm: "Short-term: luxury retail, marketing; Long-term: robotics",
    teamResearch: "AV background — Cruise, Wayve, Tesla",
    teamCommercial: "API monetization planned early 2026",
    stateSpace: "2D",
    horizon: "Multiple minutes",
    latency: "Real-time",
    mapX: 60, mapY: 22,
  },
  {
    ...
    hq: "SF / London",
    founded: "2010",
    valuation: "Not relevant (Google DeepMind)",
    funding: "Internal — Waymo's World Model",
    gtm: "Autonomous Vehicles (Waymo's World Model)",
    teamResearch: "Leading DeepMind researchers across key papers",
    teamCommercial: "Not commercialized; Google distribution network",
    stateSpace: "3D",
    horizon: "Multiple minutes",
    latency: "Real-time",
    resolution: "720p",
  ...
  },
  {
    ...
    founded: "2018",
    valuation: "$3.6B",
    funding: "$543M — General Atlantic, Alphabet, NVIDIA, SoftBank, QIA",
    gtm: "Creative / media; expanding to simulation, robotics, digital twin",
    teamResearch: "Anastasis Germanidis (CTO, ex-IBM computer vision); Naveen Venkat (ex-Cruise)",
    teamCommercial: "GTM & Partnerships from Airbnb and Meta",
    stateSpace: "2D & 3D",
    horizon: "Multiple minutes",
    latency: "Real-time",
    resolution: "720p",
  ...
  },
  {
    ...
    funding: "$133M — Innovation Endeavors, Khosla Ventures, General Catalyst",
    gtm: "Gaming — AI bots and NPCs outperforming traditional deterministic AI",
    teamResearch: "Gaming and AV background — Medal, Epic Games, Wayve",
    teamCommercial: "Early team from Medal, VC",
    stateSpace: "2D",
    latency: "Real-time",
    mapX: 24, mapY: 18,
  },
  {
    ...
    founded: "2023",
    valuation: "$3.08B",
    funding: "$153M — Sequoia, Benchmark, Aleph",
    gtm: "Video generation / editing: gaming, streaming, e-commerce, XR; real-time AI video API",
    teamResearch: "Ariana Chen (CTO, ex-Google Brain and NVIDIA)",
    teamCommercial: "Moshe Shalev (Co-founder/CPO); Noy Levinson (GM Business, ex-Amazon VC & Startups)",
    stateSpace: "2D",
    horizon: "Up to 5 seconds",
    latency: "Real-time, 40ms/frame (16 FPS)",
    resolution: "Pixel-level and latent-based",
    mapX: 16, mapY: 12,
  },
  {
    name: "Rhoda AI",
    ...
    founded: "2024",
    valuation: "$933M",
    funding: "$230M — Mayfield, Khosla Ventures, MVP",
    gtm: "Robotics",
    teamResearch: "Eric Chen (postdoc in Fei-Fei Li's lab; founding member of World Labs)",
    teamCommercial: "Jagdeep Singh (serial founder: QuantumScape, Infinera, Ciena)",
    stateSpace: "Latent State",
    mapX: 82, mapY: 36,
  },
  {
    ...
    founded: "2026",
    valuation: "€3B",
    funding: "€750M — General Catalyst, Hiro, HV, Cathay",
    gtm: "Healthcare (partnered with Nabla clinical AI — contextual agents across full patient visits)",
    teamResearch: "Yann LeCun (Image Joint Embedding Predictive Architecture)",
    teamCommercial: "Alex LeBrun (ex-CEO Nabla; Wit.ai acq. by Meta); potential Meta GTM partnership",
    stateSpace: "Representation space",
    mapX: 40, mapY: 44,
  },
  {
    name: "Skild",
    ...
    hq: "San Mateo, CA",
    valuation: "$14B",
    funding: "$2.2B — SoftBank, Sequoia, NVIDIA, Amazon",
    gtm: "Industrial robotics",
    mapX: 90, mapY: 44,
  },
  {
    ...
    founded: "2024",
    valuation: "$6B",
    funding: "$1.1B — Capital G, Lux Capital, Sequoia, Jeff Bezos",
    gtm: "Consumer robotics",
    teamResearch: "Adnan Esmail, Brian Ichter, Karol Hausman, Sergey Levine",
    teamCommercial: "Lachy Groom",
    mapX: 84, mapY: 56,
  },
];
          ...
          blocks: [
            {
              ...
              rationale:
                "Designed to test geometric consistency, lighting fidelity, and material rendering. In this example, Marble (a 3D world model) maintains consistent fidelity as you explore the space — whereas with 2D models (e.g., Project Genie), objects may appear initially but vanish when the camera pans away and returns.",
              links: [
                {
                  label: "Marble ↗",
                ...
                },
                {
                  ...
                  hint: "Explore requires Google sign-in — use the ▷ button to watch without signing in.",
                },
                {
                  label: "Odyssey ↗",
          ...
          blocks: [
            {
              ...
              rationale:
                "Designed to illustrate that 3D models (e.g., Marble) struggle to capture dynamic movement — in this example, the waterfall appears static. By contrast, 2D models (e.g., Project Genie) render fluid motion more naturally, with waves and grass visibly responding to environmental forces.",
              links: [
                {
                  label: "Marble ↗",
